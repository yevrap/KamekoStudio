...
| Exempt | Its full hash is in `COMMIT_EXEMPTIONS`, with a reason | Neither linted nor guarded, and reported by both checks with its reason. Today: the executive's three 2026-09-22 commits (the migration, the E1 direction, ADR-0009) and five 2026-09-23 commits recording ADR-0011 (SHS-063) |
