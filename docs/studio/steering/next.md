...
**Next:** `build SHS-065` — a ticketed studio commit may change the studio's own skills and conductor
...
- [SHS-064](../iterations/07/tickets/SHS-064-river-run-power-up-hud-real-time.md) is Done and pushed (`fee743d`), layout and real-time timers both; #35 and #38
  close with it. Close's postdeploy marker for the fork: `POWERUP_MAX_STEP_S`.
- [SHS-065](../iterations/07/tickets/SHS-065-studio-edits-its-own-workflow.md) is the sprint's one studio-machinery ticket (backlog #41).
