...
- Plan is in `docs/studio/iterations/06/plan.md`; the record ticket is [SHS-062](../iterations/06/tickets/SHS-062-iteration-record.md). Gate base:
  `studio-iteration-05`.
- [SHS-059](../iterations/06/tickets/SHS-059-ticket-mentions-link-to-tickets.md)'s scope was counted at plan: 383 mentions of [SHS-043](../iterations/03/tickets/SHS-043-ticket-prefix.md)…058 in 52 Markdown files,
...
- Q12 was blank: ⭐ power-ups are [SHS-060](../iterations/06/tickets/SHS-060-river-run-power-ups.md). #21 waits for sprint 07's process slot.
