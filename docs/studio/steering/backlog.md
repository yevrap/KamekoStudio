...
| 6 | River Run fork — a near-miss streak: tight dodges build a streak the HUD shows, a hit or a wide pass resets it | feature | M | River Run questionnaire Q3=C | Needs refinement: Q12 |
| 7 | River Run fork — biomes that change play: the stretch of river changes how the boat handles (friction) and what floats in it, and the change is noticeable | feature | M | River Run questionnaire Q6=B, Q4=A/C | Needs refinement: Q12 |
