...
| IR09-4 | [SHS-073](tickets/SHS-073-samovar-forgiving-brim.md): `hygiene`'s wikilink pattern flags an array of arrays in studio code; [SHS-073](tickets/SHS-073-samovar-forgiving-brim.md)'s first push failed on it and the game code was bent around it, recorded only in the ticket's Result | process | **Backlog #59** (process, S, Ready) |
