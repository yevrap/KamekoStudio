...
- **The check's blind spots were about what it *did not look at*, not about what it judged
  ...
  third, twelve in the fourth, six in the fifth, four in the sixth, nine in the seventh,
  four in the eighth, and in the ninth the stripper itself — which had begun deleting text
  a reader sees, and so failed *open*.
