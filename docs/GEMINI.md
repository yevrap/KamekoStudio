...
- **`studio/`** — Shadow Studio's handbook (process, guardrails, roles, decisions, iterations), plus `studio/steering/`: the executive-facing board, scorecard, handoff, inbox, input ledger and open questions.
