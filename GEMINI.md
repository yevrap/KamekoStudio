...
| `games/durak/` | Durak | DOM | Classic Russian card game. Play vs Computer or PvP. Attack and defend with pairs grouped visually. Trump suit chosen randomly from deck bottom. Cards feature a minimalist readability-focused layout (large rank, smaller suit) optimized for mobile iOS PWAs. |
